...
export const initialStadiums: Stadium[] = [
  {
    ...
    locationCoords: { lat: -2.1862, lng: -79.9213 },
    varCertified: true,
  ...
  },
  {
    ...
    locationCoords: { lat: -0.3167, lng: -78.4458 },
    varCertified: true,
  ...
  },
  {
    ...
    grassHeight: 22,
    vorConnectivity: "Fibra Principal + Respaldo",
    locationCoords: { lat: -2.1969, lng: -79.8931 },
    varCertified: true,
    lastInspectionDate: "2026-01-20",
    image: "https://images.unsplash.com/photo-1518605368461-1e1e1a5a1f6a?auto=format&fit=crop&q=80&w=400",
  },
  {
    id: "chucho-benitez",
    ...
    capacity: 10152,
    lightingLux: 1100,
    grassType: "Césped Sintético",
    grassHeight: 25,
    fifaQualityPro: true,
    vorConnectivity: "Satelital",
    locationCoords: { lat: -2.1005, lng: -79.8973 },
    varCertified: false,
